...
namespace IIS.Proba_11
{
    ...
    public class Город : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Proba_11.Улица fУлица;
        ...
        [PropertyStorage(new string[] {
                "Улица"})]
        [NotNull()]
        public virtual IIS.Proba_11.Улица Улица
        {
            get
            {
                ...
                IIS.Proba_11.Улица result = this.fУлица;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ГородE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ГородE", typeof(IIS.Proba_11.Город));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ГородL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ГородL", typeof(IIS.Proba_11.Город));
                }
            }
        }
    }
